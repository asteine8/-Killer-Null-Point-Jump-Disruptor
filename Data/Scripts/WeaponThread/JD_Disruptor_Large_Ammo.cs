...
{ // Don't edit above this line
    ...
    {
        private AmmoDef JDD_LargeDisruptor_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy",  // Magazine SBC SubtypeID, for Ammo Users, "Energy" for Energy-Weapons.
            AmmoRound = "JDD_LargeDisruptor_Ammo",  // In-game Name
            ...
            Mass = 0, // in kilograms. Force Applied Onto Target. 
        ...
        private AmmoDef JDD_LargeDamage_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "JDD_LargeDamage_Ammo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.00000000001f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 12000f,
            Mass = 200000f, // in kilograms
            Health = 1200f, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying.
            BackKickForce = 2.5f,
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f,
                        Width = .75f,
                        Color = Color(red: 55, green: 255, blue: 0, alpha: 1f), // Main Color
                    },
                    Trail = new TrailDef
                    {
                        Enable = false,
                        Material = "WeaponLaser",
                        DecayTime = 5,
                        Color = Color(red: 66, green: 255, blue: 0, alpha: 0.5f), // Back Color 43, 0, 74 (front) 56, 32, 0 (back)
                        Back = false,
                        CustomWidth = .2f,
                        UseWidthVariance = false,
                        UseColorFade = true,
