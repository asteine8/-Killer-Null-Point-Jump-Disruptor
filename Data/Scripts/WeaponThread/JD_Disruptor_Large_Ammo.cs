...
{ // Don't edit above this line
    ...
    {
        private AmmoDef JD_Disruptor_Ammo_Large => new AmmoDef
        {
            AmmoMagazine = "Energy",  // Magazine SBC SubtypeID, for Ammo Users, "Energy" for Energy-Weapons.
            AmmoRound = "JD_Disruptor_Ammo-large",  // In-game Name
            HybridRound = true, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0.18f, // (((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 3000f,  //Damage Numbers. A Steel Plate is worth 100 units.
            Mass = 200000f, // in kilograms. Force Applied Onto Target. 
            ...
            BackKickForce = 3000000f,  // Force applied to User upon firing.
            ...
            {
                AreaEffect = JumpNullField, // Disabled = do not use area effect at all, Explosive, Radiant, AntiSmart, JumpNullField, EnergySinkField, AnchorField, EmpField, OffenseField, NavField, DotField.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 250,  // This is in meters-per-second.
                MaxTrajectory = 2000f,  // This is in meters. 1000, is 1k distance.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 4f,
                        Width = .75f,
                        Color = Color(red: 55, green: 25, blue: 255, alpha: 1f), // Main Color
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
        ...
        private AmmoDef JD_Disruptor_Ammo_DamagingLarge => new AmmoDef
        {
            AmmoMagazine = "Energy",  // Magazine SBC SubtypeID, for Ammo Users, "Energy" for Energy-Weapons.
            AmmoRound = "JD_Disruptor_AmmoDamaging-large",  // In-game Name
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            EnergyCost = 0f, //(((EnergyCost * DefaultDamage) * ShotsPerSecond) * BarrelsPerShot) * ShotsPerBarrel
            BaseDamage = 2000f,  // Damage Numbers. A Steel Plate is worth 100 units.
            Mass = 0f, // in kilograms. Force Applied Onto Target. 
            Health = 0f, // 0 = disabled, otherwise how much damage it can take from other trajectiles before dying. This is in hits, to simplify. A value of 10, means 10 hits.
            BackKickForce = 0f,  // Force applied to User upon firing.
            DecayPerShot = 0f,  // Damage to Weapon System, on Firing.
            ...
            DamageScales = new DamageScaleDef
            {
                ...
                Shields = new ShieldDef
                {
                    Modifier = 1f,  // Modifier for Ammo when hitting a Shield.  Emp adds bonus damage & a shield activation delay in addition to this value.
                    Type = Energy,  // Used by Shield Enhancers. Options are Kinetic, Energy, Emp , and Bypass. Bypass ignores shielding, and enables BypassModifier.
                    BypassModifier = 1f,  // % of damage loss upon bypassing a Shield, for this Projectile.
                },
                // first true/false (ignoreOthers) will cause projectiles to pass through all blocks that do not match the custom subtypeIds.
                Custom = new CustomScalesDef
            ...
            AreaEffect = new AreaDamageDef  // This section controls AOE effects, and area damage.
            {
                ...
                AreaEffectDamage = 5000f, // 0 = use spillover from BaseDamage, otherwise use this value.
                AreaEffectRadius = 5f,
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f,  // Used typically for Missiles, this is the starting speed & accel increase per second. At 10, your shot starts at 10m\s, and gains 10m\s per second.
                DesiredSpeed = 250,  // This is in meters-per-second.
                MaxTrajectory = 250,  // This is in meters. 1000, is 1k distance.
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                GravityMultiplier = 0f, // Gravity multiplier, influences the trajectory of the projectile, value greater than 0 to enable.
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Particles = new AmmoParticleDef
                {
                    ...
                    Hit = new ParticleDef
                    {
                        ...
                        ApplyToShield = true,
                        ShrinkByDistance = true,
                        Color = Color(red: 0, green: 255, blue: 0, alpha: 200),
                        Offset = Vector(x: 0, y: 0, z: 0),
                        Extras = new ParticleOptionDef
                        {
                            Loop = false,
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f,
                        Width = 4f,
                        Color = Color(red: 0, green: 255, blue: 0, alpha: 1), // Main Color
                    },
                    Trail = new TrailDef
                    {
                        Enable = true,
            ...
            {
                TravelSound = "",  // Audio played to nearby players, in proximity.
                HitSound = "",  // Audio played on hit, to non-shielded blocks.
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
