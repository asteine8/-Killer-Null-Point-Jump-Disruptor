...
{ // Don't edit above this line
    partial class Weapons
    {
        ...
        private AmmoDef JDD_SmallDisruptor_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy",  // Magazine SBC SubtypeID, for Ammo Users, "Energy" for Energy-Weapons.
            AmmoRound = "JDD_SmallDisruptor_Ammo",  // In-game Name
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                MaxLifeTime = 0, // 0 is disabled, Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).
                AccelPerSec = 0f,  // Used typically for Missiles, this is the starting speed & accel increase per second. At 10, your shot starts at 10m\s, and gains 10m\s per second.
                DesiredSpeed = 450f,  // This is in meters-per-second.
        ...
        private AmmoDef JDD_SmallDamage_Ammo => new AmmoDef
        {
            AmmoMagazine = "Energy",
            AmmoRound = "JDD_SmallDamage_Ammo",
            HybridRound = false, //AmmoMagazine based weapon with energy cost
            ...
            AreaEffect = new AreaDamageDef
            {
                ...
                AreaEffectDamage = 500, // 0 = use spillover from BaseDamage, otherwise use this value.
                AreaEffectRadius = 3.25f,
                Pulse = new PulseDef // interval measured in game ticks (60 == 1 second), pulseChance chance (0 - 100) that an entity in field will be hit
                {
                    Interval = 0,
                    PulseChance = 0,
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                AccelPerSec = 0f,
                DesiredSpeed = 450f,  // This is in meters-per-second.
                MaxTrajectory = 2250f,  // This is in meters. 1000, is 1k distance.
                FieldTime = 0, // 0 is disabled, a value causes the projectile to come to rest, spawn a field and remain for a time (Measured in game ticks, 60 = 1 second)
                SpeedVariance = Random(start: 0, end: 0), // subtracts value from DesiredSpeed
                RangeVariance = Random(start: 0, end: 0), // subtracts value from MaxTrajectory
                Smarts = new SmartsDef
