...
namespace JDD_Mod_Thread {   
    partial class Weapons {
        ...
        WeaponDefinition JD_Disruptor_Small => new WeaponDefinition {   // ExampleWeapon_ClassID is your Custom ID for this gun.

            Assignments = new ModelAssignmentsDef 
            {
                MountPoints = new[] {
                    new MountPointDef {  // FixedMounts, leave Muzzle, Azimuth, and Elevation as "None" to become non-turrets.
                        SubtypeId = "JD_Disruptor_Small",  // Your Cubeblock SubtypeID, for your Gun.
                        ...
                        DurabilityMod = 0.25f,  // Affects Durability of Turret to weapons-fire.
                    },
            ...
            HardPoint = new HardPointDef 
            {
                ...
                Loading = new LoadingDef {
                    ...
                    ReloadTime = 360, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).  If your Weapon is a Beam, This is now Charge-Rate.
                    DelayUntilFire = 138, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).  How long the weapon wait after fire-trigger to actually fire.
                    ...
                    DelayAfterBurst = 120, // Measured in game ticks (6 = 100ms, 60 = 1 seconds, etc..).  This is reload-time for Energy-Weapons. Or timing between bursts for Non-Energy weapons.
                ...
                Audio = new HardPointAudioDef {
                    PreFiringSound = "JDD_PreFire_2_short",  // Audio for Warm-up effect.
